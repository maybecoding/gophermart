// Package luna Реализация алгоритма [Луна](https://ru.wikipedia.org/wiki/Алгоритм_Луна)
package luna
...
// Sum - Вычисление контрольной суммы. Для вычисления необходимой контрольной цифры нужно взять остаток от деления на 10
